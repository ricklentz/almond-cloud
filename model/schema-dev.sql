...
--
-- Host: crowdie.stanford.edu    Database: thingengine
-- ------------------------------------------------------
...
CREATE TABLE `device_code_version` (
  ...
  `factory` mediumtext COLLATE utf8_bin,
...
) ENGINE=InnoDB AUTO_INCREMENT=1691158 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7578 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-17 18:50:24
